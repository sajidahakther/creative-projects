...
//Akhil Nair 2016 fave
//setting the variables
w = 0,
s = 900;

function setup() {
 //creating the canvas 900x900
createCanvas(s, s)
}

function draw() {
 //creating the colour for the stroke by n % 255, rgb colours go upto 255. 0 x 0.32 modulo 255,
 stroke(w * .32 % 255, w * .3 % 255, w * .28 % 255, 50);
 // the direction in which the lines move, and when it takes up the entire canvas, it begins again.
 line((w++ >> s) % s, 0, w++ % s, s)
}